...
const formRules: FormRules<CreateOrUpdateTableRequestData> = {
  username: [{ required: true, trigger: "blur", message: "请输入用户名：必填" }],
  email: [
    { required: true, trigger: "blur", message: "请输入邮箱：必填" },
    {
      type: "email",
      message: "请输入正确的邮箱格式",
      trigger: ["blur", "change"]
  ...
  password: [{ required: true, trigger: "blur", message: "请输入密码:必填" }],
  sex: [{ required: true, trigger: "blur", message: "请选择性别:必填" }]
}
// #region 重置密码
  ...
  <div class="app-container">
    ...
    >
      <el-form ref="formRef" :model="formData" :rules="formRules" label-width="100px" label-position="left">
        ...
        <el-form-item v-if="formData.id === undefined" prop="sex" label="性别:">
